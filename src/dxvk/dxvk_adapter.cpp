...
#undef CHECK_FEATURE_NEED
  ...
  Rc<DxvkDevice> DxvkAdapter::createDevice(
    ...
    if (!enableDescriptorBuffer) {
      ...
      devExtensions.khrPushDescriptor.setMode(DxvkExtMode::Disabled);
    }
    ...
    if (enableDescriptorBuffer) {
      ...
      enabledFeatures.extDescriptorBuffer.descriptorBufferPushDescriptors =
        m_deviceFeatures.extDescriptorBuffer.descriptorBufferPushDescriptors &&
        m_deviceFeatures.khrPushDescriptor;
    }
