...
namespace dxvk {
  ...
  : m_device(device), m_reservedSize(device->properties().extDescriptorHeap.minResourceHeapReservedRange) { }
  ...
  DxvkResourceDescriptorRange* DxvkResourceDescriptorHeap::addRanges() {
    ...
    VkDeviceSize deviceHeapSize = std::min(MaxHeapSize, properties.maxResourceHeapSize - properties.minResourceHeapReservedRange);
