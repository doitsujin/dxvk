...
namespace dxvk {
  ...
  void DxvkContext::changeImageLayout(
    ...
    if (image->info().layout != layout) {
      ...
      m_cmd->track(image->trackRef(DxvkAccess::Write));
    }
  }
  ...
  void DxvkContext::clearBuffer(
    ...
    m_cmd->track(buffer->trackRef(DxvkAccess::Write));
  }
  ...
  void DxvkContext::clearBufferView(
    ...
    m_cmd->track(bufferView->trackRef(DxvkAccess::Write));
  }
  ...
  void DxvkContext::copyBuffer(
    ...
    m_cmd->track(dstBuffer->trackRef(DxvkAccess::Write));
    m_cmd->track(srcBuffer->trackRef(DxvkAccess::Read));
  }
  ...
  void DxvkContext::copyPackedBufferImage(
    ...
    if (srcBuffer == dstBuffer
     ...
     && srcView->info().offset + srcView->info().size > dstView->info().offset) {
      ...
      m_cmd->track(tmpBuffer->trackRef(DxvkAccess::Write));
    }
  ...
  void DxvkContext::initImage(
    ...
    if (initialLayout == VK_IMAGE_LAYOUT_PREINITIALIZED) {
      ...
      m_cmd->track(image->trackRef(DxvkAccess::None));
    } else {
      ...
      if (formatInfo->flags.any(DxvkFormatFlag::BlockCompressed, DxvkFormatFlag::MultiPlane)) {
        for (auto aspects = formatInfo->aspectMask; aspects; ) {
          ...
          m_cmd->track(zeroBuffer->trackRef(DxvkAccess::Read));
        }
      } else {
  ...
  void DxvkContext::emitBufferBarrier(
    ...
    m_cmd->track(resource->trackRef(DxvkAccess::Write));
  }
  ...
  void DxvkContext::generateMipmaps(
    ...
    m_cmd->track(imageView->trackRef(DxvkAccess::Write));
    m_cmd->track(sampler->trackRef());
  }
  ...
  void DxvkContext::invalidateBuffer(
    ...
    m_cmd->track(DxvkTrackingRef(std::move(prevAllocation)));
  ...
  void DxvkContext::transformImage(
    ...
    if (srcLayout != dstLayout) {
      ...
      m_cmd->track(dstImage->trackRef(DxvkAccess::Write));
    }
  }
  ...
  void DxvkContext::uploadBuffer(
    ...
    m_cmd->track(source->trackRef(DxvkAccess::Read));
    m_cmd->track(buffer->trackRef(DxvkAccess::Write));
  }
  ...
  void DxvkContext::updatePageTable(
    ...
    m_cmd->track(bindInfo.dstResource->trackRef(DxvkAccess::Write));
  }
  ...
  void DxvkContext::launchCuKernelNVX(
    ...
    for (auto& r : buffers) {
      ...
      m_cmd->track(r.first->trackRef(r.second.test(DxvkAccess::Write) ? DxvkAccess::Write : DxvkAccess::Read));
    }
  ...
  void DxvkContext::blitImageFb(
    ...
    m_cmd->track(dstView->trackRef(DxvkAccess::Write));
    m_cmd->track(srcView->trackRef(DxvkAccess::Read));
    m_cmd->track(sampler->trackRef());
  }
  ...
  void DxvkContext::copyBufferToImageHw(
    ...
    m_cmd->track(image->trackRef(DxvkAccess::Write));
    m_cmd->track(buffer->trackRef(DxvkAccess::Read));
  }
  ...
  void DxvkContext::copyImageToBufferHw(
    ...
    m_cmd->track(buffer->trackRef(DxvkAccess::Write));
    m_cmd->track(image->trackRef(DxvkAccess::Read));
  }
  ...
  void DxvkContext::copyImageHw(
    ...
    m_cmd->track(dstImage->trackRef(DxvkAccess::Write));
    m_cmd->track(srcImage->trackRef(DxvkAccess::Read));
  }
  ...
  void DxvkContext::copySparseBufferPages(
    ...
    m_cmd->track(sparse->trackRef(ToBuffer ? DxvkAccess::Read : DxvkAccess::Write));
    m_cmd->track(buffer->trackRef(ToBuffer ? DxvkAccess::Write : DxvkAccess::Read));
  }
  ...
  void DxvkContext::renderPassBindFramebuffer(
    ...
    for (uint32_t i = 0; i < framebufferInfo.numAttachments(); i++)
      m_cmd->track(framebufferInfo.getAttachment(i).view->trackRef(DxvkAccess::Write));
    ...
    if (!m_flags.test(DxvkContextFlag::GpXfbActive)) {
      ...
      for (uint32_t i = 0; i < MaxNumXfbBuffers; i++) {
        ...
        if (physSlice.handle != VK_NULL_HANDLE)
          m_cmd->track(m_state.xfb.activeCounters[i].buffer()->trackRef(DxvkAccess::Read));
      }
  ...
  void DxvkContext::pauseTransformFeedback() {
    if (m_flags.test(DxvkContextFlag::GpXfbActive)) {
      ...
      for (uint32_t i = 0; i < MaxNumXfbBuffers; i++) {
        ...
        if (physSlice.handle != VK_NULL_HANDLE)
          m_cmd->track(m_state.xfb.activeCounters[i].buffer()->trackRef(DxvkAccess::Write));
        ...
        switch (binding.descriptorType) {
          case VK_DESCRIPTOR_TYPE_SAMPLER: {
            ...
            if (res.sampler != nullptr) {
              ...
              if (m_rcTracked.set(binding.resourceBinding))
                m_cmd->track(res.sampler->trackRef());
            } else {
          ...
          case VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE: {
            ...
            if (res.imageView != nullptr && res.imageView->handle(binding.viewType) != VK_NULL_HANDLE) {
              ...
              if (m_rcTracked.set(binding.resourceBinding))
                m_cmd->track(res.imageView->trackRef(DxvkAccess::Read));
            } else {
              descriptorInfo.image.sampler = VK_NULL_HANDLE;
              descriptorInfo.image.imageView = VK_NULL_HANDLE;
              descriptorInfo.image.imageLayout = VK_IMAGE_LAYOUT_UNDEFINED;
          ...
          case VK_DESCRIPTOR_TYPE_STORAGE_IMAGE: {
            ...
            if (res.imageView != nullptr && res.imageView->handle(binding.viewType) != VK_NULL_HANDLE) {
              ...
              if (m_rcTracked.set(binding.resourceBinding))
                m_cmd->track(res.imageView->trackRef(DxvkAccess::Write));
            } else {
              descriptorInfo.image.sampler = VK_NULL_HANDLE;
              descriptorInfo.image.imageView = VK_NULL_HANDLE;
              descriptorInfo.image.imageLayout = VK_IMAGE_LAYOUT_UNDEFINED;
          ...
          case VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER: {
            ...
            if (res.bufferView != nullptr) {
              ...
              if (m_rcTracked.set(binding.resourceBinding))
                m_cmd->track(res.bufferView->trackRef(DxvkAccess::Read));
            } else {
          ...
          case VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER: {
            ...
            if (res.bufferView != nullptr) {
              ...
              if (m_rcTracked.set(binding.resourceBinding))
                m_cmd->track(res.bufferView->trackRef(DxvkAccess::Write));
            } else {
              descriptorInfo.texelBuffer = VK_NULL_HANDLE;
            }
          } break;
          ...
          case VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER: {
            ...
            if (res.bufferSlice.length()) {
              ...
              if (m_rcTracked.set(binding.resourceBinding))
                m_cmd->track(res.bufferSlice.buffer()->trackRef(DxvkAccess::Read));
            } else {
          ...
          case VK_DESCRIPTOR_TYPE_STORAGE_BUFFER: {
            ...
            if (res.bufferSlice.length()) {
              ...
              if (m_rcTracked.set(binding.resourceBinding))
                m_cmd->track(res.bufferSlice.buffer()->trackRef(DxvkAccess::Write));
            } else {
              descriptorInfo.buffer.buffer = VK_NULL_HANDLE;
              descriptorInfo.buffer.offset = 0;
              descriptorInfo.buffer.range = VK_WHOLE_SIZE;
  ...
  void DxvkContext::transitionColorAttachment(
    ...
    if (oldLayout != attachment.view->image()->info().layout) {
      ...
      m_cmd->track(attachment.view->trackRef(DxvkAccess::Write));
    }
  }
  ...
  bool DxvkContext::updateIndexBufferBinding() {
    ...
    if (m_vbTracked.set(MaxNumVertexBindings))
      m_cmd->track(m_state.vi.indexBuffer.buffer()->trackRef(DxvkAccess::Read));
    ...
    for (uint32_t i = 0; i < m_state.gp.state.il.bindingCount(); i++) {
      ...
      if (likely(m_state.vi.vertexBuffers[binding].length())) {
        ...
        if (m_vbTracked.set(binding))
          m_cmd->track(m_state.vi.vertexBuffers[binding].buffer()->trackRef(DxvkAccess::Read));
      } else {
  ...
  void DxvkContext::trackDrawBuffer() {
    if (m_flags.test(DxvkContextFlag::DirtyDrawBuffer)) {
      ...
      if (m_state.id.argBuffer.length())
        m_cmd->track(m_state.id.argBuffer.buffer()->trackRef(DxvkAccess::Read));

      if (m_state.id.cntBuffer.length())
        m_cmd->track(m_state.id.cntBuffer.buffer()->trackRef(DxvkAccess::Read));
    }
  }
  ...
  void DxvkContext::relocateResources(
    ...
    for (size_t i = 0; i < bufferCount; i++) {
      ...
      m_cmd->track(info.buffer->trackRef(DxvkAccess::Write));
    ...
    for (size_t i = 0; i < imageCount; i++) {
      ...
      m_cmd->track(info.image->trackRef(DxvkAccess::Write));
