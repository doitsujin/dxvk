...
namespace dxvk::hud {
  ...
  void HudFrameTimeItem::processFrameTimes(
    ...
    ctx.cmd->track(m_gpuBuffer->trackRef(DxvkAccess::Write));
    ctx.cmd->track(m_query->trackRef());
  }
  ...
  void HudFrameTimeItem::drawFrameTimeGraph(
    ...
    ctx.cmd->track(m_gpuBuffer->trackRef(DxvkAccess::Read));
  }
  ...
  void HudMemoryDetailsItem::flushDraws(
    ...
    ctx.cmd->track(m_dataBuffer->trackRef(DxvkAccess::Read));
