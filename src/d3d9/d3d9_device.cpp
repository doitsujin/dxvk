...
namespace dxvk {
  ...
  HRESULT STDMETHODCALLTYPE D3D9DeviceEx::UpdateSurface(
    ...
    UpdateTextureFromBuffer(srcTextureInfo, dstTextureInfo, src->GetSubresource(), dst->GetSubresource(), srcOffset, extent, dstOffset);
  ...
  HRESULT STDMETHODCALLTYPE D3D9DeviceEx::UpdateTexture(
    ...
    for (uint32_t a = 0; a < arraySlices; a++) {
      ...
      for (uint32_t m = 0; m < mipLevels; m++) {
        ...
        UpdateTextureFromBuffer(srcTexInfo, dstTexInfo, subresource, subresource, offset, extent, offset);
