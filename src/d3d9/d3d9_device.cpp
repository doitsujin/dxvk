...
namespace dxvk {
  ...
  void D3D9DeviceEx::UpdateTextureTypeMismatchesForTexture(uint32_t stateSampler) {
    ...
    bool shaderUsesTexture = shaderViewType != VK_IMAGE_VIEW_TYPE_1D; // D3D9 does not have 1D textures. The value of VIEW_TYPE_1D is 0 which is the default when there is no declaration for the type.
