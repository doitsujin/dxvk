...
SDL_PROC(bool, SDL_GetWindowPosition, (SDL_Window*, int*, int*))
SDL_PROC(bool, SDL_GetWindowSize, (SDL_Window*, int*, int*))
SDL_PROC(bool, SDL_GetWindowSizeInPixels, (SDL_Window*, int*, int*))
SDL_PROC(bool, SDL_SetWindowBordered, (SDL_Window*, bool))
SDL_PROC(bool, SDL_RestoreWindow, (SDL_Window*))
SDL_PROC(bool, SDL_MaximizeWindow, (SDL_Window*))
SDL_PROC(bool, SDL_MinimizeWindow, (SDL_Window*))
