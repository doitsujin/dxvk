...
namespace dxvk {
  ...
  static std::unordered_map<
    ...
    DxsoSemanticEq> g_transientMappings = {
      {{DxsoUsage::Texcoord,   0}, 0},
      {{DxsoUsage::Texcoord,   1}, 1},
      {{DxsoUsage::Texcoord,   2}, 2},
      {{DxsoUsage::Texcoord,   3}, 3},
      {{DxsoUsage::Texcoord,   4}, 4},
      {{DxsoUsage::Texcoord,   5}, 5},
      {{DxsoUsage::Texcoord,   6}, 6},
      {{DxsoUsage::Texcoord,   7}, 7},
      {{DxsoUsage::Texcoord,   8}, 8},
      {{DxsoUsage::Texcoord,   9}, 9},

      {{DxsoUsage::Color,      0}, 10},
      {{DxsoUsage::Color,      1}, 11},
      {{DxsoUsage::Color,      2}, 12},

      {{DxsoUsage::Fog,        0}, 13},
      {{DxsoUsage::Position,   0}, 14},
